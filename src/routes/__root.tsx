    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="btn-outline px-5 py-2.5">
            Go home
          </a>
        </div>
      </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "LUVAAN — Premium Footwear, Manufacturing & Shoe Care" },
      {
        name: "description",
        content:
          "LUVAAN INTERNATIONAL PRIVATE LIMITED — Pune-based footwear manufacturing, direct-to-customer shoes and professional shoe cleaning services.",
      },
      { name: "author", content: "LUVAAN INTERNATIONAL PRIVATE LIMITED" },
